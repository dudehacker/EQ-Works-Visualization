...
export default function PopUp ({open,onClose,selected}) {
    ...
    maxWidth="xl" fullWidth>
        <DialogContent>
        <Graph poi={poi} stats={stats} selected={selected} selectedDate={date} colors={colors} measure={measure}/>
        <Table poi={poi} stats={stats} selected={selected} onRowClick={onRowClick} onCellClick={setMeasure}/>
        </DialogContent>
    </Dialog>)
}